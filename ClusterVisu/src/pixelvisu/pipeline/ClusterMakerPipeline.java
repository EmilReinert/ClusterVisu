...
public class ClusterMakerPipeline extends JFrame implements Runnable {
	...
	public VisuPipeline visu; 
	public Data data;

	public Color bg_color = Color.WHITE;
	
	public ClusterMakerPipeline(Data d, String path) throws IOException {
		thread = new Thread(this);
		image = new BufferedImage(WIDTH,HEIGHT, BufferedImage.TYPE_INT_RGB);
		pixels = ((DataBufferInt) image.getRaster().getDataBuffer()).getData();
		visu = new VisuPipeline(WIDTH,HEIGHT,d, bg_color);
	...
	public static void main(String[] args) throws IOException {
		...
		ClusterMakerPipeline clum = new ClusterMakerPipeline(d, path);
	}
}
