...
//		System.out.println(obj.toString());
	...
	public int getSqueezeColor(Bundle seqs, int sec_idx, int row, int idx, int size) {
		// returns color for squeeze data
		
		int value =  seqs.getSqueezed(sec_idx, row, idx, size);
		return getColor(value);
	}
