...
public class ClusterMakerDump extends JFrame implements Runnable {
	...
	public VisuDump visu; 
	public Data data;

	public Color bg_color = Color.WHITE;
	
	public ClusterMakerDump(Data d, String path) throws IOException {
		thread = new Thread(this);
		image = new BufferedImage(WIDTH,HEIGHT, BufferedImage.TYPE_INT_RGB);
		pixels = ((DataBufferInt) image.getRaster().getDataBuffer()).getData();
		visu = new VisuDump(WIDTH,HEIGHT,d, bg_color);
	...
	public static void main(String[] args) throws IOException {
		...
		ClusterMakerDump clum = new ClusterMakerDump(d, path);
	}
}
